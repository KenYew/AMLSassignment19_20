...
#======================================================================
def data_preprocessing(X, y, split_percentage, feature_type):
...
def data_scaling(data, n_components):
    ...
    feature_reduction = PCA(n_components=n_components, whiten=True, random_state=0)
    scaled_data = scaler.fit_transform(data)
    scaled_data = feature_reduction.fit_transform(data)
...
def extract_features_labels_from_cartoon_set(feature_type, sample_size): 
    ...
    :return:
        img_features:  an array containing 68 landmark points or 128 x 128 pixel data for each image in which a face was detected
...
#======================================================================
def build_model_task_A1(X_train, X_test, y_train, y_test):
